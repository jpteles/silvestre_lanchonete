...
function Contato_Local(){
    return(
      <section className="w-full flex flex-col lg:flex-row justify-around items-center lg:items-start mt-6 space-y-5 lg:space-y-0 lg:space-x-5">
      <div className="w-11/12 md:w-2/3 lg:w-1/4 rounded-lg mt-5 p-5">
      ...
      <div className="w-11/12 md:w-2/3 lg:w-1/2 h-full md:h-96 lg:h-auto p-5">
        <iframe
          title="Meu Iframe"
